...
public class SkillWeaponBreak extends WeaponSkill {

    @Override
    public String getSkillId() { return "bs2_skill_weapon_break"; }
    ...
    @Override
    public String getTranslationKey() { return "skill.blacksouls.weapon_break.name"; }
    ...
    public void execute(ServerPlayer player, BSPlayerStats stats) {
        ...
        player.sendSystemMessage(Component.translatable("message.blacksouls.skill.weapon_break.use", player.getName().getString()).withStyle(ChatFormatting.WHITE));
