...
public final class ItemPorcupineShield extends ShieldItem {
    public ItemPorcupineShield(Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable(getDescriptionId() + ".stat.2").withStyle(ChatFormatting.AQUA));
        tooltip.add(Component.translatable(getDescriptionId() + ".stat.3").withStyle(ChatFormatting.AQUA));
        tooltip.add(Component.translatable(getDescriptionId() + ".stat.4").withStyle(ChatFormatting.RED));
    }
}
