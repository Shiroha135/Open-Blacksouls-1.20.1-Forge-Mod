...
public class ItemHemostaticCloth extends Item {

    public ItemHemostaticCloth(Properties properties) {
        super(properties);
    }
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(Level level, Player player, @NotNull InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            if (player.hasEffect(BlackSouls.BUFF_BLEEDING.get())) {
                player.removeEffect(BlackSouls.BUFF_BLEEDING.get());
            }
