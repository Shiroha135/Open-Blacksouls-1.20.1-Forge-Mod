...
public class MmdSkinRegisterClient {
    ...
    private static final Set<String> RESERVED_SKIN_DIRECTORIES = Set.of(
        PathConstants.DEFAULT_ANIM_DIR,
        PathConstants.CUSTOM_ANIM_DIR,
        PathConstants.STAGE_ANIM_DIR,
        PathConstants.DEFAULT_MORPH_DIR,
        PathConstants.CUSTOM_MORPH_DIR,
        PathConstants.SCENE_MODEL_DIR,
        PathConstants.SHADER_DIR
    );
    ...
    public static void onRegisterEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        if (modelDirs != null) {
            for (File i : modelDirs) {
                ...
                if (i.isDirectory()
                    && !name.startsWith(PathConstants.ENTITY_PLAYER_DIR)
                    && !RESERVED_SKIN_DIRECTORIES.contains(name)) {
