...
public class ConfigData {
    ...
    public boolean mmeRenderingEnabled = true;
    public float mmeExposure = 1.05f;
    public float mmeRoughness = 0.5f;
    public float mmeSpecularIntensity = 0.85f;
    public float mmeSoftShadow = 0.7f;
    public float mmeRimPower = 3.2f;
    public float mmeRimIntensity = 0.18f;
    public float mmeSubsurface = 0.45f;
    public float mmeHairAnisotropy = 0.65f;
    public float mmeFillLight = 0.35f;
    ...
    private void normalize() {
        ...
        mmeExposure = clamp(mmeExposure, 0.5f, 2.0f);
        mmeRoughness = clamp(mmeRoughness, 0.0f, 1.0f);
        mmeSpecularIntensity = clamp(mmeSpecularIntensity, 0.0f, 2.0f);
        mmeSoftShadow = clamp(mmeSoftShadow, 0.0f, 1.0f);
        mmeRimPower = clamp(mmeRimPower, 0.5f, 8.0f);
        mmeRimIntensity = clamp(mmeRimIntensity, 0.0f, 1.0f);
        mmeSubsurface = clamp(mmeSubsurface, 0.0f, 1.0f);
        mmeHairAnisotropy = clamp(mmeHairAnisotropy, 0.0f, 1.0f);
        mmeFillLight = clamp(mmeFillLight, 0.0f, 1.0f);
