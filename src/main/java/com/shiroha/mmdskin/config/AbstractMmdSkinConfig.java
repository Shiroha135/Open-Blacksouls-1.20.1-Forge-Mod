...
public abstract class AbstractMmdSkinConfig implements ConfigManager.IConfigProvider {
    ...
    @Override public boolean isMmeRenderingEnabled() { return data.mmeRenderingEnabled; }
    @Override public float getMmeExposure() { return data.mmeExposure; }
    @Override public float getMmeRoughness() { return data.mmeRoughness; }
    @Override public float getMmeSpecularIntensity() { return data.mmeSpecularIntensity; }
    @Override public float getMmeSoftShadow() { return data.mmeSoftShadow; }
    @Override public float getMmeRimPower() { return data.mmeRimPower; }
    @Override public float getMmeRimIntensity() { return data.mmeRimIntensity; }
    @Override public float getMmeSubsurface() { return data.mmeSubsurface; }
    @Override public float getMmeHairAnisotropy() { return data.mmeHairAnisotropy; }
    @Override public float getMmeFillLight() { return data.mmeFillLight; }
