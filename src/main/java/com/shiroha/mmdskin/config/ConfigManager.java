...
public class ConfigManager {
    ...
    public static boolean isMmeRenderingEnabled() {
        return provider != null ? provider.isMmeRenderingEnabled() : true;
    }

    public static float getMmeExposure() {
        return provider != null ? provider.getMmeExposure() : 1.05f;
    }

    public static float getMmeRoughness() {
        return provider != null ? provider.getMmeRoughness() : 0.5f;
    }

    public static float getMmeSpecularIntensity() {
        return provider != null ? provider.getMmeSpecularIntensity() : 0.85f;
    }

    public static float getMmeSoftShadow() {
        return provider != null ? provider.getMmeSoftShadow() : 0.7f;
    }

    public static float getMmeRimPower() {
        return provider != null ? provider.getMmeRimPower() : 3.2f;
    }

    public static float getMmeRimIntensity() {
        return provider != null ? provider.getMmeRimIntensity() : 0.18f;
    }

    public static float getMmeSubsurface() {
        return provider != null ? provider.getMmeSubsurface() : 0.45f;
    }

    public static float getMmeHairAnisotropy() {
        return provider != null ? provider.getMmeHairAnisotropy() : 0.65f;
    }

    public static float getMmeFillLight() {
        return provider != null ? provider.getMmeFillLight() : 0.35f;
    }
    ...
    public interface IConfigProvider extends IRenderConfig, IToonConfig, IMmeConfig, IPhysicsConfig, IVRConfig {
